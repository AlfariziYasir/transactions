...
import (
	...
	"github.com/AlfariziYasir/transactions/services/payment/internal/adapter/gateway"
	"github.com/AlfariziYasir/transactions/services/payment/internal/adapter/handler"
	"github.com/AlfariziYasir/transactions/services/payment/internal/adapter/repository"
	"github.com/AlfariziYasir/transactions/services/payment/internal/core/services"
	"github.com/AlfariziYasir/transactions/services/payment/migrations"
...
//go:embed payment_api.swagger.json
var spec []byte
...
func main() {
	...
	rmqConn, err := amqp091.DialConfig(
		...
		amqp091.Config{
			...
			Properties: amqp091.Table{
				"product":     cfg.Name,
				"version":     cfg.Version,
				"description": "handles out event at payment service",
			},
	...
	paymentHandler := handler.NewHandler(l, svc)
	...
	webhook := handler.NewWebhook(cfg.WebhookServerKey, svc, l)
	...
	httpMux.HandleFunc("/payment/notification/", webhook.Notification)
